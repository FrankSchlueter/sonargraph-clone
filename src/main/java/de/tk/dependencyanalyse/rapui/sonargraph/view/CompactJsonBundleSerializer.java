package de.tk.dependencyanalyse.rapui.sonargraph.view;

import de.tk.dependencyanalyse.rapui.sonargraph.bundle.BundleDependencyRecord;
import de.tk.dependencyanalyse.rapui.sonargraph.bundle.BundleModel;
import de.tk.dependencyanalyse.rapui.sonargraph.deprules.AllowedDependency;
import de.tk.dependencyanalyse.rapui.sonargraph.deprules.DependencyRulesService;
import de.tk.dependencyanalyse.rapui.sonargraph.model.Artifact;
import de.tk.dependencyanalyse.rapui.sonargraph.model.ArtifactModel;
...
public final class CompactJsonBundleSerializer {
    ...
    private static void appendBundles(StringBuilder sb, ArtifactModel am, BundleModel model) {
        ...
        for (Artifact a : am.artifacts()) {
            ...
            if (!isPackage(a, am)) {
                de.tk.dependencyanalyse.rapui.sonargraph.bundle.BundleModel.BundleInfo info =
                        model.infoOf(a.id());
